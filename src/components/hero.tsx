        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="mt-4 text-lg md:text-xl text-muted-foreground max-w-xl">
              A passionate frontend developer specializing in creating beautiful, intuitive, and high-performance web applications. With expertise in React.js and a commitment to clean code, I transform complex ideas into seamless digital experiences.
            </p>
